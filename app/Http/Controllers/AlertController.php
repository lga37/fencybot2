...
class AlertController extends Controller
{
    ...
    private function sendTelegram(int $user_id,$type=null,$lat=null,$lng=null){
        #Auth::user()->notify(new TelegramNotification());
        #echo 'user_id:'.$user_id.'<br>';
        $chat_id = User::find($user_id)->select('chat_id');
        User::find($user_id)->notify(new TelegramNotification());
