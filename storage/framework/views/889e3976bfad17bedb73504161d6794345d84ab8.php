...
<!--                             <span class="badge badge-pill badge-primary">1</span>
 -->                        </li>
                        ...
                        <li class="nav-item
                         d-flex justify-content-between align-items-center pr-4">
                            <a class="nav-link
                                <?php echo e(request()->routeIs('alert.inform') ? 'active' : ''); ?>"
                                href="<?php echo e(route('alert.inform')); ?>">
                                <span data-feather="users"></span>
                                <?php echo e(__('Inform')); ?>
...
<?php /**PATH /var/www/html/resources/views/layouts/adm.blade.php ENDPATH**/ ?>